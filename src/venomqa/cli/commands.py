...
# Templates removed - now in cli/templates.py (see imports above)


# Placeholder to avoid breaking anything that referenced ACTIONS_INIT_PY directly
# (all actual templates are now imported from cli/templates.py)
_TEMPLATES_NOTE = '''"""Reusable actions for VenomQA tests (v1 API).
