...
from venomqa.sandbox.context import Context
...
# These will be migrated to other contexts later
# For now, import from v1 to maintain compatibility
if TYPE_CHECKING:
...
class World:
    ...
    Example::
        ...
        from venomqa import World, HttpClient, PostgresAdapter

        world = World(
            api=HttpClient("http://localhost:8000"),
            systems={
                "db": PostgresAdapter("postgresql://..."),
            },
        )

        # Create a checkpoint
        cp_id = world.checkpoint("initial")

        # Do some work
        world.act(some_action)
    ...
    def __init__(
        ...
        """Initialize the World sandbox.

        Args:
            api: The HTTP client for the API being tested.
            systems: Rollbackable systems to include in checkpoints.
            context: Initial context (created if not provided).
            setup: Function called before exploration starts.
            clients: Named HTTP clients for multi-role testing.
            teardown: Function called after exploration ends.
            state_from_context: Context keys to include in state identity.
            auth: Auth configuration for automatic token injection.
        """
        self.api = api
        ...
        # Track the last action result for invariants
        self._last_action_result: Any | None = None
    ...
    def register_system(self, name: str, system: Rollbackable) -> None:
        ...
        Args:
            name: Key to use in systems dict and observations.
            system: A Rollbackable system implementation.
        """
    ...
    def act(self, action: Action) -> ActionResult:
        ...
        Returns:
            The ActionResult from executing the action.
        """
    ...
    def observe(self) -> State:
        ...
        Returns:
            State snapshot with observations from all registered systems.
        """
