"""Checkpoint - A saved state of the entire world."""
...
class Checkpoint:
    ...
    A Checkpoint captures the state of all systems at a moment in time.
    It can be used to rollback to that state later.

    Attributes:
        id: Unique identifier for this checkpoint
        name: Human-readable name for the checkpoint
        system_checkpoints: Per-system checkpoint data (implementation-specific)
